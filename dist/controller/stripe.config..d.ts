...
export declare class STRIPE {
    addNewCustomer(name: any, email: any): Promise<Stripe.Response<Stripe.Customer>>;
    buySubscription(customerId: any, priceId: any): Promise<{
        status: any;
        client_secret: any;
    }>;
    createPaymentMethod(type: any, card: any): Promise<Stripe.Response<Stripe.PaymentMethod>>;
    createCheckoutSession(customer: any, price: any, token: any, currency: any, mode: any, payment_method_types: any): Promise<any>;
    retrievesessions(csId: any): Promise<Stripe.Response<Stripe.Checkout.Session>>;
    getSubscriptionDetails(subcriptionId: any): Promise<Stripe.Response<Stripe.Subscription>>;
    attachPaymentToCustomer(res: any, paymentMethodId: any, customerId: any): Promise<any>;
    listOfPayments(customerId: any): Promise<Stripe.Response<Stripe.ApiList<Stripe.PaymentMethod>>>;
    deletePaymentMethod(paymentMethodId: any): Promise<Stripe.Response<Stripe.PaymentMethod>>;
    listOfSubscription(customerId: any): Promise<Stripe.Response<Stripe.ApiList<Stripe.Subscription>>>;
    addpaymentMethod(res: any, card: any): Promise<any>;
    updateSubscription(subcriptionId: any, paymentMethodId: any): Promise<Stripe.Response<Stripe.Subscription>>;
    retrievePaymentMethod(methodId: any): Promise<Stripe.Response<Stripe.PaymentMethod>>;
    getInvoices(customer: any): Promise<Stripe.Response<Stripe.ApiList<Stripe.Invoice>>>;
    getUserCards(customerId: any): Promise<any>;
    retrieveProduct(planId: any): Promise<Stripe.Response<Stripe.Product>>;
    retrievePrice(priceId: any): Promise<Stripe.Response<Stripe.Price>>;
    retrieveCustomer(customerId: any): Promise<Stripe.Response<Stripe.Customer | Stripe.DeletedCustomer>>;
    cancelAtPeriodEnd(subcriptionId: any): Promise<Stripe.Response<Stripe.Subscription>>;
    listOfProduct(): Promise<Stripe.Response<Stripe.ApiList<Stripe.Product>>>;
    listOfPrice(): Promise<Stripe.Response<Stripe.ApiList<Stripe.Price>>>;
    product_details(product_id: any): Promise<Stripe.Response<Stripe.Product>>;
    create_product(name: any): Promise<Stripe.Response<Stripe.Product>>;
    update_product(id: any, name: any): Promise<Stripe.Response<Stripe.Product>>;
    create_price(currency: any, unit_amount: any, recurring: any, product_name: any): Promise<Stripe.Response<Stripe.Price>>;
    update_price(id: any, unit_amount: any, name: any, currency: any, interval: any): Promise<Stripe.Response<Stripe.Price>>;
}
